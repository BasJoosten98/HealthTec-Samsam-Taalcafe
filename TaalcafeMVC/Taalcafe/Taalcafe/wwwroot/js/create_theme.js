...
const vragen = document.getElementById("Questions");
...
function RenderVragenLijst() {
    ...
    $.each(vragenLijst, function (index) {
        ...
        */
        ...
        let listString = '<li class="list-group-item vraag"><div class="row"><div class="col-3" style="overflow:hidden;">'
        listString += '<input class="btn btn-danger" type="button" onclick="RemoveVraag(' + index.toString() + ')" value="X"></input></div>';
